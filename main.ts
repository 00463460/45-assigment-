...
let nam:string="kashan"
 ...
 // question#5
 let fam_per:string="Albert Einstein"
 ...
 // question#21
 let poem:{title:string, authur:string ,written:number}={
   title:"lines for Samson Agnoistic",
   authur:"Samson Agnoistic",
   written:1997,
 }
 console.log(`The poem “${poem.title}” by ${poem.authur} written in ${poem.written}.`);4
 
 // question#22
 let internatinalError:string[]=["Ahmed","Danish","Raza","Basit"]
 ...
 // question#37
 function make_shirts(size:string="large", messege:string="I love Typescript")
 {
     console.log(`Making a ${size} t_shirt with the messege ${messege},printed on it.`);
